 ...
 * this to seed the multiselect prompt with installed agents pre-checked.
 */
...
/**
 * Resolve a `--target=` flag value to a list of `AgentTarget` instances.
 * Accepts:
 ...
 */
export function resolveTargetFlag(value: string, loc: InstallLocation): AgentTarget[] {
